...
/**
 * Utility class that provides operations to handle dates, using the
 * java.util.Calendar
 * methods
 *
...
public class Calendar {
    ...
    /**
     * Change the calendar to the given month and update the day number to the last
     * day of the month if the current day number is greater
     *
